...
namespace SampleCode
{
    public class HelperMethods
    {
        ...
        public string TranslateServiceIdToFriendlyName(BankcardService bankcardService)
        {
            ...
            if (bankcardService.ServiceId == "3E2DE00001") return "Worldpay Global Gateway";
            if (bankcardService.ServiceId == "832E400001") return "Worldpay";
            ...
            if (bankcardService.ServiceId == "2C36000001") return "Worldpay";
            ...
            if (bankcardService.ServiceId == "355931300C") return "Worldpay Global Gateway";
            if (bankcardService.ServiceId == "8CEA11300C") return "Worldpay";
            ...
            , bool _UseWorkflowId)  
        {
            ...
            try
            {
                ...
                if (_TT == TransactionType.CaptureAll)
				{
                    ...
                    _Response = Cwsbc.CaptureAll(_sessionToken, _CaptureDifferenceData, null, _applicationProfileId, _merchantProfileId, _serviceId);
				}
                if (_TT == TransactionType.CaptureAllAsync)
                {
                    if (CredentialRequired())
                    ...
                    _Response.Add(Cwsbc.CaptureAllAsync(_sessionToken, _CaptureDifferenceData, null, _applicationProfileId, _merchantProfileId, _serviceId));
                }
